...
INSERT INTO `marca` VALUES (1,'coca cola'),(2,'seven'),(3,'circo'),(4,'pepsi');
...
INSERT INTO `producto` VALUES (1,'soda',1),(2,'globo',3);
...
INSERT INTO `venta` VALUES (1,'2020-03-27'),(2,'2020-03-27');
...
CREATE TABLE `venta_producto` (
  ...
  CONSTRAINT `fk_venta` FOREIGN KEY (`id_venta`) REFERENCES `venta` (`idventa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `venta_producto` VALUES (1,1,20),(1,2,10),(2,2,5);
...
-- Dump completed on 2020-03-27  9:18:43
